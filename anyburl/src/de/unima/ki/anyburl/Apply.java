	...
	public static void main(String[] args) throws IOException {
		...
		try {
			if (args != null) {
				...
				if (Settings.PREDICTION_TYPE.equals("aRx")) {
					...
					// add
					Settings.PATH_TYPE = IOHelper.getProperty(prop, "PATH_TYPE", Settings.PATH_TYPE);
		...
		if (Settings.PREDICTION_TYPE.equals("aRx")) {			
			...
			for (String value : values) {
				...
				TripleSet trainingSet = new TripleSet(Settings.PATH_TRAINING, Settings.PATH_TYPE);
