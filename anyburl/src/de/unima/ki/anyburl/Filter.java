...
public class Filter {
	...
	/**
	 * Path to the file where the predictions are stored.
	 */
	public static String PATH_INPUT_PREDICTIONS = "";
	
	/**
	 * Path to the output file where the filtered predictions are stored.
	 */
	public static String PATH_FILTERED_PREDICTIONS = "";
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			PATH_INPUT_PREDICTIONS = IOHelper.getProperty(prop, "PATH_INPUT_PREDICTIONS", PATH_INPUT_PREDICTIONS);
			PATH_FILTERED_PREDICTIONS = IOHelper.getProperty(prop, "PATH_FILTERED_PREDICTIONS", PATH_FILTERED_PREDICTIONS);
		...
		ResultSet rs = new ResultSet(PATH_INPUT_PREDICTIONS, true, TOP_K);
		...
		// TripleSet xxx = new TripleSet();
		// xxx.addTripleSet(trainingSet);
		// xxx.addTripleSet(validationSet);
