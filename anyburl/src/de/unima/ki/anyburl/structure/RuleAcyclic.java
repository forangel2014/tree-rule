...
public abstract class RuleAcyclic extends Rule {
	...
	*/
	...
	public void computeScores(TripleSet triples) {
		...
		if (this.isXRule()) {
			...
			// if (Settings.BEAM_NOT_DFS && this.bodysize() > 1) this.beamValuesReversed("X", xvalues, triples);
			...
			// if (Settings.BEAM_NOT_DFS && this.bodysize() > 1) this.beamValuesReversed("Y", yvalues, triples);
	...
	private boolean isBodyTrueAcyclicCN(String variable, String value, int bodyIndex, HashSet<String> previousValues, TripleSet triples) {
	...
	*/
	...
	public void computeValuesReversed(String targetVariable, HashSet<String> targetValues, TripleSet ts, Timer count) {
