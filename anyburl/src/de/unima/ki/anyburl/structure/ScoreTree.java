...
public class ScoreTree {
	...
	public void getAsLinkedList(LinkedHashMap<String, Double> list, double ps, int level, String myself) {
	...
	public void getExplainedCandidates(HashMap<String, HashSet<Rule>> explainedCandidates, LinkedList<Rule> explanations, int level) {	
		...
		if (!this.root) {
			...
			for (String v : this.storedValues) {
				...
				explainedCandidates.get(v).add(this.explanation);
			}
		}
	}
