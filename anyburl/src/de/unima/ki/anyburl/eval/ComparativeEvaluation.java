...
public class ComparativeEvaluation {
	...
	public static String target = "CODEX-M";
	...
	public static void main(String[] args) throws IOException {
		...
		if (target.equals("HETIONET")) {
			trainingSet = new TripleSet("data/Hetionet/train_all.txt");
			validationSet = new TripleSet("data/Hetionet/dev.txt");
			testSet = new TripleSet("data/Hetionet/test.txt");
			gold = null;
		}
		...
		if (target.equals("HETIONET")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("AnyBURL", "exp/hetionet/hetionet-predictions-100", true, 100),
					new ResultSet("AnyBURL", "exp/hetionet/hetionet-predictions-500", true, 100),
		...
		if (target.equals("CODEX-M")) {
			...
			results = new ResultSet[]{
					new ResultSet("AnyBULR (default)    ", "exp/dream/codex-m-explore/codex-m-500-50-allW-u5", true, 100),
					new ResultSet("AnyBULR (unweighted) ", "exp/dream/codex-m-explore/codex-m-500-50-all-u5", true, 100),
					null,
					new ResultSet("AC1 tcp1  500", "exp/dream/codex-m-explore/codex-m-500-50-tcp1-ac1-u5", true, 100),
					new ResultSet("AC1 tcp1 1000", "exp/dream/codex-m-explore/codex-m-1000-50-tcp1-ac1-u5", true, 100),
					new ResultSet("AC1 tcp1 1000", "exp/dream/codex-m-explore/codex-m-1000-50-tcp1-ac1-u10", true, 100),
					new ResultSet("AC1 tcp2  500", "exp/dream/codex-m-explore/codex-m-500-50-ac1-u5", true, 100),
					
					new ResultSet("max               ", "exp/patrick/new/codex-m-symbolic-max-50", true, 100),
					new ResultSet("noisy5            ", "exp/patrick/new/codex-m-symbolic-noisy5-50", true, 100),
					new ResultSet("noisyX5           ", "exp/patrick/new/codex-m-symbolic-noisyX5-50", true, 100),
					new ResultSet("noisyZ5           ", "exp/patrick/new/codex-m-symbolic-noisyZ5-50", true, 100),
		...
		if (target.equals("WN18RR")) {
			...
			results = new ResultSet[]{
					...
					new ResultSet("AnyBURL* 50 max    ", "exp/patrick/wn18rr-symbolic-max-50", true, 100),
					new ResultSet("AnyBURL* 50 noisy1 ", "exp/patrick/wn18rr-symbolic-noisy1-50", true, 100),
					new ResultSet("AnyBURL* 50 noisy3 ", "exp/patrick/wn18rr-symbolic-noisy3-50", true, 100),
					new ResultSet("AnyBURL* 50 noisy5 ", "exp/patrick/wn18rr-symbolic-noisy5-50", true, 100),
					new ResultSet("AnyBURL* 50 noisy10", "exp/patrick/wn18rr-symbolic-noisy10-50", true, 100),
	...
	if (target.equals("NELL995")) {
		...
		if (target.equals("FB15-237")) {
			...
			results = new ResultSet[]{
					...
					null,
					// new ResultSet("AnyBURL* 10 sym     ", "exp/patrick/fb237-symbolic-10", true, 100),
					// new ResultSet("AnyBURL* 10 sym     ", "exp/patrick/fb237-symbolic-noisy5-10", true, 100),
					// null,
					new ResultSet("AnyBURL* 100 max    ", "exp/patrick/fb237-symbolic-max-100", true, 100),
					new ResultSet("AnyBURL* 100 noisy  ", "exp/patrick/fb237-symbolic-noisy5-100", true, 100),
					null,
					//new ResultSet("AnyBURL* 500 max    ", "exp/patrick/fb237-symbolic-max-500", true, 100),
					//new ResultSet("AnyBURL* 500 noisy  ", "exp/patrick/fb237-symbolic-noisy5-500", true, 100),
					//null,
					new ResultSet("AnyBURL* 1000 max    ", "exp/patrick/fb237-symbolic-max-1000", true, 100),
					new ResultSet("AnyBURL* 1000 noisy2 ", "exp/patrick/fb237-symbolic-noisy2-1000", true, 100),
					new ResultSet("AnyBURL* 1000 noisy3 ", "exp/patrick/fb237-symbolic-noisy3-1000", true, 100),
					new ResultSet("AnyBURL* 1000 noisy5 ", "exp/patrick/fb237-symbolic-noisy5-1000", true, 100),
					new ResultSet("AnyBURL* 1000 noisy7 ", "exp/patrick/fb237-symbolic-noisy7-1000", true, 100),
					new ResultSet("AnyBURL* 1000 noisy10", "exp/patrick/fb237-symbolic-noisy10-1000", true, 100)
